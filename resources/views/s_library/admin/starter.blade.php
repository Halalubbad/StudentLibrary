        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{route('eduAdmin.dashboard')}}" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href=" {{route('eduAdmin.dashboard')}} " class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('password.edit') }}" class="nav-link">
                                ...
                                <p class="text">{{ __('library.edit_password') }}</p>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('edu.logout') }}" class="nav-link">
                                <i class="nav-icon far fa-circle text-danger"></i>
