...
class AuthController extends Controller
{
    ...
    public function showRegisterView(Request $request)
    {
        ...
        return response()->view('s_library.auth.register',['universities' => $universities,'guard'=> $request->guard]);
    }
    ...
    public function showLoginView(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            return response()->view('s_library.auth.login',['guard'=> $request->guard]);
        } else {
    ...
    {
        return response()->view('s_library.auth.edit-password');
    }
    ...
    public function logout(Request $request)
    {
        ...
        return redirect()->route('edu.login', $guard);
    }
}
